...
set output 'plot_output_NBYTES_200.svg'

# labels and titles
set xlabel 'Memory Footprint (KByte)'
set ylabel 'Performance (MFlop/s)'
set title 'Data structure comparison: 200 Bytes'
...
plot 'temp_int_200_dist.dat' title 'internal - dist' w linespoints ls 1, \
     'temp_int_200_check.dat' title 'internal - check' w linespoints ls 2, \
     'temp_int_200_main.dat' title 'internal - main' w linespoints ls 3, \
     'temp_ext_200_dist.dat' title 'external - dist' w linespoints ls 4, \
     'temp_ext_200_check.dat' title 'external - check' w linespoints ls 5, \
     'temp_ext_200_main.dat' title 'external - main' w linespoints ls 6, \
